...
export const archiveProjectsEn: readonly ArchiveProject[] = [
  // E-commerce & marketplace
  {
    ...
    category: "E-commerce",
    description:
      "Game top-up & e-commerce platform: storefront, product catalog, and checkout flow.",
  ...
  },
  {
    ...
    description:
      "Personal-shopper (jastip) platform: storefront, admin dashboard, and an automated price scraper.",
  ...
  },
  {
    ...
    group: "ecommerce",
    category: "E-commerce",
    description: "End-to-end online store: Go REST API + Next.js storefront.",
    tech: "Go · TypeScript",
    repoVisibility: "private",
  },
  {
    ...
    category: "E-commerce",
    description:
      "E-commerce backend for a Muslim clothing store: catalog, orders, JWT + Google OAuth.",
  ...
  },
  {
    ...
    group: "ecommerce",
    category: "Marketplace",
    description: "Deals/promo platform: Go backend, storefront, and back-office.",
    tech: "Go · TypeScript",
  ...
  // Business systems & dashboards
  {
    ...
    group: "systems",
    category: "Dashboard",
    description: "Operations dashboard + company landing page.",
    tech: "PHP · TypeScript",
    repoVisibility: "private",
  },
  {
    ...
    group: "systems",
    category: "Analytics",
    description: "Web analytics dashboard: event tracking + Go API.",
    tech: "Go · TypeScript",
    repoVisibility: "private",
  },
  {
    ...
    group: "systems",
    category: "CMS",
    description: "CMS + management system for the Berdikari group.",
    tech: "PHP · TypeScript",
    repoVisibility: "private",
  },
  {
    ...
    description: "KBU business system: API, admin dashboard, and public site.",
    tech: "PHP · JavaScript",
    repoVisibility: "private",
  },
  {
    ...
    group: "systems",
    category: "Web App",
    description: "Personal finance tracker: Go API + Next.js frontend.",
    tech: "Go · TypeScript",
    repoVisibility: "private",
  },
  {
    ...
    description: "Web platform: Go backend + Next.js frontend.",
    tech: "Go · TypeScript",
    repoVisibility: "private",
  },
  {
    ...
    group: "systems",
    category: "Inventory",
    description: "Workshop inventory system: parts stock and transactions.",
    tech: "JavaScript",
    repoVisibility: "private",
  },
  {
    ...
    group: "systems",
    category: "API",
    description: "Trading analytics backend + MT5 .set file generator.",
    tech: "Go · Chi · SQLC",
    repoVisibility: "private",
  },
  ...
  // Websites & landing pages
  {
    ...
    description:
      "Swimming-pool construction service: a conversion landing page + lead-capture backend.",
    tech: "Next.js · Go",
    repoVisibility: "private",
  },
  {
    ...
    group: "web",
    category: "Web App",
    description: "Property listing platform with a fast, modern UI.",
    tech: "Nuxt · Vue",
    repoVisibility: "private",
  },
  {
    ...
    group: "web",
    category: "Corporate",
    description: "Corporate website & system for PT Trofi (frontend + backend).",
    tech: "TypeScript",
    repoVisibility: "private",
  },
  {
    ...
    group: "web",
    category: "Corporate",
    description: "Corporate website for PT Pear.",
    tech: "TypeScript",
    repoVisibility: "private",
  },
  {
  ...
  // Open source & tools
  {
    ...
    category: "CLI",
    description:
      "Go REST API boilerplate CLI generator: Clean Architecture, Paseto, audit log, i18n.",
    tech: "Go",
    repoVisibility: "public",
    repoUrl: `${GH}/chasago`,
  },
  {
    ...
    group: "oss",
    category: "API",
    description: "Task-management REST API in Rust.",
    tech: "Rust",
    repoVisibility: "public",
  ...
  },
  {
    ...
    group: "oss",
    category: "Reference",
    description: "Reference Go service: DDD + clean/hexagonal architecture.",
    tech: "Go",
    repoVisibility: "public",
  ...
  },
  {
    ...
    group: "oss",
    category: "CLI",
    description: "CLI task tracker in Go.",
    tech: "Go",
    repoVisibility: "public",
  ...
  },
  {
    ...
    group: "oss",
    category: "Tool",
    description: "A Go utility for routing analysis.",
    tech: "Go",
    repoVisibility: "public",
  ...
  // Mobile
  {
    ...
    group: "mobile",
    category: "Mobile",
    description: "Cross-platform mobile app (Flutter).",
    tech: "Flutter · Dart",
    repoVisibility: "public",
    repoUrl: `${GH}/veyra`,
  },
  {
    ...
    group: "mobile",
    category: "iOS",
    description: "iOS app for OBD-II vehicle diagnostics.",
    tech: "Swift · iOS",
    repoVisibility: "public",
    repoUrl: `${GH}/obd-app`,
  },
