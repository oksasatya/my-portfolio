...
export const metadata: Metadata = {
  ...
  description:
    "Portfolio Oksa Satya, Full Stack Developer berfokus backend (Golang, Laravel, Spring Boot, Next.js). Membangun aplikasi web skalabel, API, dan platform SaaS. Menerima jasa pembuatan website, aplikasi web, sistem informasi, dan integrasi sistem.",
  keywords: [
    "Oksa Satya",
    "Backend Engineer",
  ...
  openGraph: {
    ...
    locale: "id_ID",
    type: "website",
    // Social image provided by app/opengraph-image.tsx (generated 1200x630).
  },
  twitter: {
